...
public class SM2 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		/* BigInteger px = new BigInteger(
		 ...
		 BigInteger privateKey = new BigInteger( "128B2FA8 BD433C6C 068C8D80 3DFF7979 2A519A55 171B1B65 "
		 		+ "0C23661D 15897263".replace(" ", ""), 16);*/
		 ...
		 System.out.println(privateKey.bitLength());
